  ...
  <div className='flex items-center justify-between'>
    <div className='flex items-center gap-2'>
      <button
        onClick={onPrevDay}
        disabled={!hasPrevDay}
        className='rounded-lg p-1 text-slate-500 transition-colors hover:bg-slate-200 disabled:opacity-30 disabled:hover:bg-transparent dark:text-slate-400 dark:hover:bg-slate-800'
        aria-label='Dia anterior'
      >
        <ChevronLeft className='h-5 w-5' />
      </button>
      <span className='min-w-[120px] text-center text-sm font-medium text-slate-700 dark:text-slate-300'>
