...
export const ForecastChips = ({ forecasts, selected, locale, onSelect }: ForecastChipsProps) => (
            ...
            >
              ...
              {forecast.validSwells.length > 0 && (
                <div className="mt-2 text-[11px] text-ocean-300">
                  <span>{forecast.validSwells.length} swell{forecast.validSwells.length > 1 ? 's' : ''}</span>
                </div>
              )}
